...
public class BdrcS3Resolver implements S3Resolver {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(BdrcS3Resolver.class);
  ...
  public String getS3Identifier(String identifier) throws ResourceIOException {
    ...
    try {
      ...
      if (access.equalsIgnoreCase("AccessOpen")) {
        LOGGER.info("S3 Resolver IdentifierInfo >>>>>>>> " + info + " Access >>" + access + " Format >> " + format);
  ...
  public static void main(String[] args) throws ResourceIOException {
    ...
    LOGGER.info("Path s3 >>" + s3.getS3Identifier("bdr:V29329_I1KG15042::I1KG150420003.jpg"));
  }
