...
public class BdrcS3Resolver implements S3Resolver {
    ...
    public String getS3Identifier(String identifier) throws ResourceIOException {
        ...
        //Works/21/W29329/images/W29329-I1KG15042/I1KG150420003.jpg
        try {
            String id="Works/";
            String[] parts=identifier.split("::");
            IdentifierInfo info=new IdentifierInfo(parts[0]);
            log.info("S3 Resolver IdentifierInfo >>>>>>>> "+info);            
            ...
            // TODO 
            // check resource access and eventually returns a Restricted content image 
            return id;
        }
        catch(Exception ex) {
